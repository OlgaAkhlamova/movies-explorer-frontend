      ...
      <div className="about-me__container">
        <div className="about-me__left-column">
          ...
          <p className="about-me__text">
            ...
            Есть семья. Я люблю слушать музыку, мастерить, а ещё увлекаюсь разнообразными путешествиями.
            Недавно начала кодить. После того, как прошла курс по веб-разработке, начала заниматься 
